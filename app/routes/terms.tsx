    ...
    <main>
      <div className="content-page card">
        ...
        <section>
          ...
          <p>Please read the Terms carefully before accessing the Site or using the Products. By using the Products or by clicking to accept or agree to the Terms when this option is made available to you, you accept and agree to be bound and abide by these Terms and our Privacy Policy, found at <a href="/privacy">https://www.nyklabs.com/privacy</a>, incorporated herein by reference. If you do not want to agree to these Terms or the Privacy Policy, you must not access or use the Product.</p>
        </section>

        <section>
          <h2>Eligibility</h2>
          <p>The products are offered and available to users who are at least 18 years of age or qualify as an adult in your country of residence. Age exception is given for playing the "daily puzzle" game found at <a href="/puzzle">https://www.nyklabs.com/puzzle</a>, which does not impose an age limit. By using the Products or participating in free token hlrr airdrop <a href="/registration">https://www.nyklabs.com/registration</a>, hlrr presale <a href="/presale">https://www.nyklabs.com/presale</a>, purchasing crypto at <a href="/purchase-crypto">https://www.nyklabs.com/purchase-crypto</a>, using nRange for liquidity pool position creation on supported Ethereum-compatible networks via Uniswap V3, PancakeSwap V3, Aerodrome, and Velodrome Slipstream protocols at <a href="/lp-manager#nrange">https://www.nyklabs.com/lp-manager#nrange</a>, or using nLock for locking liquidity pool position NFTs at <a href="/lp-manager#nlock">https://www.nyklabs.com/lp-manager#nlock</a> via Nyklab website and agreeing to these Terms, you represent and warrant that:</p>
          <ul>
