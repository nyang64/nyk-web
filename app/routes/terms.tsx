  ...
  return (
    <main>
      <div className="content-page card">
        ...
        <section>
          <h2>Eligibility</h2>
          <p>This Product is offered and available to users who are at least 18 years of age or qualify as an adult in your country of residence. Age exception is given for playing the "daily puzzle" game found at <a href="/puzzle">https://www.nyklabs.com/puzzle</a>, which does not impose an age limit. By using the Product or participating in free token hlrr airdrop <a href="/registration">https://www.nyklabs.com/registration</a>, hlrr presale <a href="/presale">https://www.nyklabs.com/presale</a>, or purchasing crypto at <a href="/purchase-crypto">https://www.nyklabs.com/purchase-crypto</a> via Nyklab website and agreeing to these Terms, you represent and warrant that:</p>
          <ul>
